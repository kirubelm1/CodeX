import { Heart, Copy, CreditCard as Edit, Trash2, Clock, Tag } from 'lucide-react';
...
export function SnippetCard({ snippet, onEdit, onDelete, onToggleFavorite, onCopy }: SnippetCardProps) {
    ...
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-200 overflow-hidden">
      ...
      <div className="px-6 pb-4">
        <div className="bg-gray-50 dark:bg-gray-900 rounded-lg overflow-hidden border border-gray-200 dark:border-gray-600">
          <SyntaxHighlighter code={snippet.code} language={snippet.language} maxLines={8} />
        </div>
      </div>
